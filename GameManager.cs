...
public class GameManager : MonoBehaviour
{
    ...
    public float walkiesCountdownStart = 20;
    public float bardMyspaceTarget = 1000;

    bool canTurnOnUIscreen = true;
    public GameObject toggleProgressText;
    bool canToggleUI = false;
    ...
    public bool canShowNewItemNotification = true;

    public string[] fartReminderSentences, fartNames;

    public bool canStartDay = false;
    ...
    public bool canShowBardIntro = true; 
   ...
   public bool canShowIntroShopkeeper = true;
    ...
    public float staminaLoseMultiplier =1; 
